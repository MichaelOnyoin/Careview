              ...
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                     <p><h6 class="mb-0"><?php echo "$login_address"; ?></h6></p>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <a class="btn btn-info " target="__blank" href="clientorder.php" style="color:yellow;padding:10px;margin:25px;">Cart history</a>
                    </div>
                  </div>
